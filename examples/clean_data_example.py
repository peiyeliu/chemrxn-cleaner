...
from chemrxn_cleaner.filters import default_filters, max_smiles_length, allowed_elements
...
# report_uspto = summarize_cleaning(raw_reactions=rxn_uspto, cleaned_reactions=cleaned_rxn_uspto)
